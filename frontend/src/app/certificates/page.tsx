...
export default function CertificatesPage() {
  ...
  useEffect(() => {
    const fetchCertificates = async () => {
      try {
        // The backend runs on port 18080
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      {/* Control Area */}
      <div className="flex-shrink-0 bg-white border-b p-2">
        <div className="flex items-center space-x-2">
          ...
          <button className="px-4 py-2 text-sm font-medium text-white bg-gray-500 rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:bg-gray-300 disabled:cursor-not-allowed" disabled={checkedCertificates.length === 0}>
            Delete
          </button>
        </div>
      </div>
